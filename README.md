...
- **Platforms Monitored**:
  - Company websites
  - LinkedIn (LINKEDIN'S CURRENT API IS VERY RESTRICTIVE AND WE CANT MONITOR/TRACK OTHER USERS ACCOUNTS AND THIRD-PARTY API PROVIDERS WERE EXPENSIVE)
  - Twitter/X
  - Reddit
  - YouTube
  - Instagram (META'S CURRENT GRAPH API COULD BE USED WITH ONLY PERSONAL ACCOUNTS AND NOT MONITOR OTHER ACCOUNTS AND THIRD PARTY API PROVIDERS WERE EXPENSIVE)
  - Facebook (SAME AS INSTAGRAM, META'S CURRENT GRAPH API COULD BE USED WITH ONLY PERSONAL ACCOUNTS AND NOT MONITOR OTHER ACCOUNTS AND THIRD PARTY API PROVIDERS WERE EXPENSIVE)
  - Truth Social (WILL BE COMING SOON DUE TO UNAVAILABILITY OF API & USING THIRD-PARTY API SCRAPERS WERE EXPENSIVE)
  - BlueSky (WILL BE COMING SOON DUE TO UNAVAILABILITY OF API & USING THIRD-PARTY API SCRAPERS WERE EXPENSIVE)
